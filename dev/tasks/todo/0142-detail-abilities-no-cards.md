...
- [ ] Las habilidades no tienen fondo de tarjeta (sin background)
- [ ] No hay borde izquierdo rojo
- [ ] No hay border-radius ni box-shadow
- [ ] El texto (nombre y descripcion) sigue siendo legible en light y dark mode
- [ ] El espaciado entre habilidades se mantiene adecuado
