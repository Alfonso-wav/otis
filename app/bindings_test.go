...
func (m *mockFetcher) FetchLocationEncounters(name string) ([]core.PokemonEncounter, error) {
	return nil, nil
}
...
func (m *mockTeamStorage) SaveTeam(team core.Team) error {
...
func (m *mockTeamStorage) DeleteTeam(name string) error {
	delete(m.teams, name)
	return nil
}
